      ...
      <div className="pointer-events-auto">
        ...
        {isOpen && (
          <div className="mb-4 w-[350px] md:w-[400px] h-[520px] glass-panel rounded-[30px] shadow-2xl flex flex-col overflow-hidden border border-white/10 animate-in slide-in-from-bottom duration-300">
            ...
            {/* Mensagens */}
            <div className="flex-1 overflow-y-auto p-5 space-y-4 bg-brand-dark/30">
              {messages.map((m, i) => (
            ...
            <div className="p-4 bg-white/5 border-t border-white/5 space-y-3">
              ...
              <div className="flex gap-2">
                <input 
                  ...
                  className="flex-1 bg-white/5 border border-white/10 p-4 rounded-xl text-xs text-white outline-none focus:border-orange-600 transition-all placeholder:text-gray-500"
                />
                <button 
                  onClick={handleSend}
                  disabled={isLoading}
